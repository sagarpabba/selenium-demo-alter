...
public class Select_Options_Page {
	...
	public String getEmailAdress(){
		...
		SeleniumCore.generateEmailStep("Request Option Page", "Get the Eamil Recipients", "Passed", "Email Address is:"+requestor);
		return requestor;
	}
	...
	public List<String> getReportLanguageList(){
		...
		if(returnlanguage.size()>0){
		 ...
		 //   Resulter.log("COMMENT_SCAN_LANGUAGE", "Supported report langauges are:"+returnlanguage);
			SeleniumCore.generateEmailStep("", "Get the Report supported language list", "Passed", "The Supported language list is:"+returnlanguage);
		...
		else
		{
			...
			SeleniumCore.generateEmailStep("", "Get the Report supported language list", "Failed", "The Supported language list is:"+returnlanguage+",language list is empty");
	...
	public Request_Review_Page newSchedule() throws Exception {
		...
		//	Resulter.log("COMMENT_SCAN_REQUEST_SCHEDULING", "Run the assessment "+frequency+" after "+aftertime+" minutes the schedule will be run");
          ...
          //  Resulter.log("COMMENT_SCHEDULING", inputname);
			...
			SeleniumCore.generateEmailStep("", "Schedule the new Assessment Run", "Passed", "The Schedule Name:"+inputname+",Start Run At:"+inputtime);
		...
		//	Resulter.log("COMMENT_SCHEDULING", "N/A");
			...
			SeleniumCore.generateEmailStep("", "Schedule the new Assessment Run", "Passed", "Run the new assessment now ");
