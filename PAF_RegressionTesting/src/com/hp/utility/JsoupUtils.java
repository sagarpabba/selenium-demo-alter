...
public class JsoupUtils {
	 ...
	 * @throws IOException
	 */
	public static String generateHtmlReport() throws IOException{
...
/**************************************************************************************************************/
		...
		int filesize = FileUtils.getSubFilesSize(report_dir, ".png");
		File[] errorshotfile = FileUtils.listFilesEndsWith(report_dir, ".png");
		if (filesize > 0) {
