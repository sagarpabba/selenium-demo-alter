 ...
 *
 */
public class BaseDriver_Remote{

	protected static RemoteWebDriver driver;
	protected static final Logger logger = Logger.getLogger(BaseDriver_Remote.class);

	@org.testng.annotations.Parameters({"hostname","browsertype"})
