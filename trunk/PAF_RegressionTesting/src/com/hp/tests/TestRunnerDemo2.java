...
//		sdp.selectDevice();
	...
	// zipFile="C:\\Python27\\workspace\\PAF_HC\\PAFReports\\PRO_SCAN-A329_Company_Name_2013-09-11_02-24-19.zip";
...
//		SeleniumCore.generateStep("new assessment", "Verify the assessment success", "blocked", "tested");
		...
		System.out.print("test is demo2 run 1");
	...
	public void test2() {
		...
		System.out.println("test demo2 run 2");
	}
