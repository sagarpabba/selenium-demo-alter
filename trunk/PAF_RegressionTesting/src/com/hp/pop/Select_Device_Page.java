...
public class Select_Device_Page {
	...
	public Select_Options_Page selectDevice() throws Exception {
		...
		//	String trid=row.getAttribute("id");		
			...
			if (devicedata.equals(devicename)) {
				...
				if(devicetype.equalsIgnoreCase("UNKNOWN")
				    ...
				    SeleniumCore.generateEmailStep("Device Select", "Selected Device infomation in the page", "Warning", "the device list information showed is incorrect......Devcie Name:"+devicedata+",Device Type:"+devicetype+",Device OS:"+
							os+",Device OS Version:"+osversion+",Product Number:"+pn+",Serial Number:"+sn+",Collections:"+collection
							+",Collection Date:"+collectiondate);
				}
				else{
					  SeleniumCore.generateEmailStep("Device Select", "Selected Device infomation in the page", "Passed", "the device list information showed is incorrect......Devcie Name:"+devicedata+",Device Type:"+devicetype+",Device OS:"+
								os+",Device OS Version:"+osversion+",Product Number:"+pn+",Serial Number:"+sn+",Collections:"+collection
								+",Collection Date:"+collectiondate);
        ...
        else
        {
      	  ...
      	  SeleniumCore.generateEmailStep("Device Select", "Selected Device infomation in the page", "Failed", "Cannot find the device:"+devicename);
	...
	public Select_Options_Page selectAllDevice(String customername,String address) throws Exception {
