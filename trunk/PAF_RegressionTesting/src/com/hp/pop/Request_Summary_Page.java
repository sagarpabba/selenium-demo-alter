...
public class Request_Summary_Page {
	...
	public void verifyPageElements() 
	{
        ...
        SeleniumCore.assertDisplayed("Assert the element displayed in the Request summary page", languages);
			...
			SeleniumCore.generateEmailStep("Request Summary detail", "Veryify the page load correctly", "Failed", "the page object cannot load correctly:"+e.getMessage());
	...
	public String getRunID() throws InterruptedException {
		...
		SeleniumCore.generateEmailStep("Request Summary detail", "Get the Request ID", "Passed", "new Assessment Request Run ID:"+runid);
		return returnrunid;
	}
