...
public class OCR {
	...
	private static String tessPath = new File("Tesseract-OCR").getAbsolutePath();
	...
	public static String recognizeText(File imageFile, String imageFormat) throws Exception {
		...
		System.out.println("Output image file path is:"+outputFile.getAbsolutePath());
		...
		System.out.println("Command run in this folder:"+tempImage.getAbsolutePath());
		pb.directory(tempImage.getParentFile());

		cmd.set(1, tempImage.getName());
		System.out.println("Comand line is:"+cmd);
		pb.command(cmd);
