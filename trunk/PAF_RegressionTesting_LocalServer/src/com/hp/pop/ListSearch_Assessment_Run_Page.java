...
public class ListSearch_Assessment_Run_Page extends PageObject {
	...
	public RunDetail_Page searchRun(String assessmenttype, String runid,String runstarttime)
		...
		while (!findresult) {		
		   ...
		   // SeleniumCore.refreshPage(driver);
			...
			SeleniumCore.waitProcessBarNotAppear(e);
//***********************************************************************************
					...
					for (WebElement row : allrows) {
						...
						if (pagerunid.equals(runid)&&runstatus.equalsIgnoreCase("COMPLETED")) {
							...
							SeleniumCore.generateEmailStep("Search the Run ID:"+runid, "Check the Run Assessment Status is Completed or Failed or Pending with 10 minutes Search", 
									"Passed", "Expected:COMPLATED;Actual:"+runstatus+",the Search Run takes:"+totaltime, driver);
						...
						if (pagerunid.equals(runid)&&runstatus.equalsIgnoreCase("FAILED")) {
							...
							SeleniumCore.generateEmailStep("Search the Run ID:"+runid, "Check the Run Assessment Status is Completed or Failed or Pending with 10 minutes Search", 
									"Failed", "Expected:COMPLATED;Actual:"+runstatus+",the Search Run takes:"+totaltime, driver);							WebElement checkbox = row.findElement(By
									.xpath("td[1]"));
							SeleniumCore.checkboxed(checkbox);
