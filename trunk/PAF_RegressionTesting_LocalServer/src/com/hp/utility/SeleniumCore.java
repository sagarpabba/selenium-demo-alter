...
public class SeleniumCore {
	 ...
	 * @param driver
	 */
	public static boolean waitForBrowserFullSync(WebDriver driver){
		final String currentbowserstate=(String)executeJS(driver, "return document.readyState;");
		...
		ExpectedCondition<Boolean> ec=new ExpectedCondition<Boolean>() {
			...
			public Boolean apply(WebDriver driver) {
				...
				String newpagestate=(String) executeJS(driver, "return document.readyState;");
